...
from main.gitsvn.views import IssueCreate, IssueFormView, IssueIdFormView, IssueList, ProjectList
...
urlpatterns = [
    ...
    path(route="issue/edit/<iid>", view=IssueIdFormView.as_view(), name="git-issue-id-edit"),
]
